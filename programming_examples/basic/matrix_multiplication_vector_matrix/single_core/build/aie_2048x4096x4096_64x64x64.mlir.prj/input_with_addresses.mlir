module {
  aie.device(npu1_1col) {
    memref.global "public" @outC_cons : memref<64x64xbf16>
    memref.global "public" @outC : memref<64x64xbf16>
    memref.global "public" @memC_cons : memref<64x64xbf16>
    memref.global "public" @memC : memref<64x64xbf16>
    memref.global "public" @memB_cons : memref<64x64xbf16>
    memref.global "public" @memB : memref<64x64xbf16>
    memref.global "public" @inB_cons : memref<64x64xbf16>
    memref.global "public" @inB : memref<64x64xbf16>
    memref.global "public" @memA_cons : memref<64x64xbf16>
    memref.global "public" @memA : memref<64x64xbf16>
    memref.global "public" @inA_cons : memref<64x64xbf16>
    memref.global "public" @inA : memref<64x64xbf16>
    ...
    %memC_buff_0 = aie.buffer(%tile_0_2) {address = 1024 : i32, sym_name = "memC_buff_0"} : memref<64x64xbf16> 
    %memC_buff_1 = aie.buffer(%tile_0_2) {address = 9216 : i32, sym_name = "memC_buff_1"} : memref<64x64xbf16> 
    ...
    %memB_cons_buff_0 = aie.buffer(%tile_0_2) {address = 17408 : i32, sym_name = "memB_cons_buff_0"} : memref<64x64xbf16> 
    %memB_cons_buff_1 = aie.buffer(%tile_0_2) {address = 25600 : i32, sym_name = "memB_cons_buff_1"} : memref<64x64xbf16> 
    ...
    %inB_cons_buff_0 = aie.buffer(%mem_tile_0_1) {address = 16384 : i32, sym_name = "inB_cons_buff_0"} : memref<64x64xbf16> 
    %inB_cons_buff_1 = aie.buffer(%mem_tile_0_1) {address = 24576 : i32, sym_name = "inB_cons_buff_1"} : memref<64x64xbf16> 
    ...
    %memA_cons_buff_0 = aie.buffer(%tile_0_2) {address = 33792 : i32, sym_name = "memA_cons_buff_0"} : memref<64x64xbf16> 
    %memA_cons_buff_1 = aie.buffer(%tile_0_2) {address = 41984 : i32, sym_name = "memA_cons_buff_1"} : memref<64x64xbf16> 
    ...
    ^bb4:  // pred: ^bb3
      ...
      func.call @zero_bf16(%memC_buff_0) : (memref<64x64xbf16>) -> ()
    ...
    ^bb6:  // pred: ^bb5
      ...
      func.call @matmul_bf16_bf16(%memA_cons_buff_0, %memB_cons_buff_0, %memC_buff_0) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>) -> ()
      aie.use_lock(%memA_cons_prod_lock, Release, 1)
      aie.use_lock(%memB_cons_prod_lock, Release, 1)
      aie.use_lock(%memA_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%memB_cons_cons_lock, AcquireGreaterEqual, 1)
      func.call @matmul_bf16_bf16(%memA_cons_buff_1, %memB_cons_buff_1, %memC_buff_0) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>) -> ()
      aie.use_lock(%memA_cons_prod_lock, Release, 1)
      aie.use_lock(%memB_cons_prod_lock, Release, 1)
    ...
    ^bb7:  // pred: ^bb5
      ...
      aie.use_lock(%memC_prod_lock, AcquireGreaterEqual, 1)
      func.call @zero_bf16(%memC_buff_1) : (memref<64x64xbf16>) -> ()
    ...
    ^bb9:  // pred: ^bb8
      aie.use_lock(%memA_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%memB_cons_cons_lock, AcquireGreaterEqual, 1)
      func.call @matmul_bf16_bf16(%memA_cons_buff_0, %memB_cons_buff_0, %memC_buff_1) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>) -> ()
      aie.use_lock(%memA_cons_prod_lock, Release, 1)
      aie.use_lock(%memB_cons_prod_lock, Release, 1)
      aie.use_lock(%memA_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.use_lock(%memB_cons_cons_lock, AcquireGreaterEqual, 1)
      func.call @matmul_bf16_bf16(%memA_cons_buff_1, %memB_cons_buff_1, %memC_buff_1) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>) -> ()
      aie.use_lock(%memA_cons_prod_lock, Release, 1)
      aie.use_lock(%memB_cons_prod_lock, Release, 1)
    ...
    ^bb7:  // 2 preds: ^bb6, ^bb8
      ...
      aie.dma_bd(%inB_cons_buff_0 : memref<64x64xbf16>, 0, 4096) {bd_id = 24 : i32, next_bd_id = 25 : i32}
      aie.use_lock(%inB_cons_cons_lock, Release, 1)
      aie.next_bd ^bb8
    ^bb8:  // pred: ^bb7
      aie.use_lock(%inB_cons_prod_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%inB_cons_buff_1 : memref<64x64xbf16>, 0, 4096) {bd_id = 25 : i32, next_bd_id = 24 : i32}
      aie.use_lock(%inB_cons_cons_lock, Release, 1)
      aie.next_bd ^bb7
    ^bb9:  // pred: ^bb6
    ...
    ^bb10:  // 2 preds: ^bb9, ^bb11
      ...
      aie.dma_bd(%inB_cons_buff_0 : memref<64x64xbf16>, 0, 4096, [<size = 8, stride = 512>, <size = 16, stride = 4>, <size = 8, stride = 64>, <size = 4, stride = 1>]) {bd_id = 26 : i32, next_bd_id = 27 : i32}
      aie.use_lock(%inB_cons_prod_lock, Release, 1)
      aie.next_bd ^bb11
    ^bb11:  // pred: ^bb10
      aie.use_lock(%inB_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%inB_cons_buff_1 : memref<64x64xbf16>, 0, 4096, [<size = 8, stride = 512>, <size = 16, stride = 4>, <size = 8, stride = 64>, <size = 4, stride = 1>]) {bd_id = 27 : i32, next_bd_id = 26 : i32}
      aie.use_lock(%inB_cons_prod_lock, Release, 1)
      aie.next_bd ^bb10
    ^bb12:  // pred: ^bb9
    ...
    ^bb16:  // 2 preds: ^bb15, ^bb17
      ...
      aie.dma_bd(%memC_cons_buff_0 : memref<64x64xbf16>, 0, 4096, [<size = 16, stride = 256>, <size = 4, stride = 4>, <size = 16, stride = 16>, <size = 4, stride = 1>]) {bd_id = 6 : i32, next_bd_id = 7 : i32}
      aie.use_lock(%memC_cons_prod_lock, Release, 1)
      aie.next_bd ^bb17
    ^bb17:  // pred: ^bb16
      aie.use_lock(%memC_cons_cons_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%memC_cons_buff_1 : memref<64x64xbf16>, 0, 4096, [<size = 16, stride = 256>, <size = 4, stride = 4>, <size = 16, stride = 16>, <size = 4, stride = 1>]) {bd_id = 7 : i32, next_bd_id = 6 : i32}
      aie.use_lock(%memC_cons_prod_lock, Release, 1)
      aie.next_bd ^bb16
    ^bb18:  // pred: ^bb15
      aie.end
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb5
      ...
      aie.dma_bd(%memB_cons_buff_0 : memref<64x64xbf16>, 0, 4096) {bd_id = 2 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%memB_cons_cons_lock, Release, 1)
      aie.next_bd ^bb5
    ^bb5:  // pred: ^bb4
      aie.use_lock(%memB_cons_prod_lock, AcquireGreaterEqual, 1)
      aie.dma_bd(%memB_cons_buff_1 : memref<64x64xbf16>, 0, 4096) {bd_id = 3 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%memB_cons_cons_lock, Release, 1)
      aie.next_bd ^bb4
    ^bb6:  // pred: ^bb3
