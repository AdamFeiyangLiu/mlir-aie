...
@inB_cons_buff_1 = external global [64 x [64 x bfloat]]
@inB_cons_buff_0 = external global [64 x [64 x bfloat]]
...
@outC_cons = external global [64 x [64 x bfloat]]
@outC = external global [64 x [64 x bfloat]]
@memC_cons = external global [64 x [64 x bfloat]]
@memC = external global [64 x [64 x bfloat]]
@memB_cons = external global [64 x [64 x bfloat]]
@memB = external global [64 x [64 x bfloat]]
@inB_cons = external global [64 x [64 x bfloat]]
@inB = external global [64 x [64 x bfloat]]
@memA_cons = external global [64 x [64 x bfloat]]
@memA = external global [64 x [64 x bfloat]]
@inA_cons = external global [64 x [64 x bfloat]]
@inA = external global [64 x [64 x bfloat]]
...
7:                                                ; preds = %4
  ...
  call void @zero_bf16(ptr @memC_buff_0)
  br label %8
...
11:                                               ; preds = %8
  ...
  call void @matmul_bf16_bf16(ptr @memA_cons_buff_0, ptr @memB_cons_buff_0, ptr @memC_buff_0)
  ...
  call void @matmul_bf16_bf16(ptr @memA_cons_buff_1, ptr @memB_cons_buff_1, ptr @memC_buff_0)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 50, i32 1)
  %12 = add i64 %9, 2
  br label %8
...
13:                                               ; preds = %8
  ...
  call void @zero_bf16(ptr @memC_buff_1)
  br label %14
...
17:                                               ; preds = %14
  ...
  call void @llvm.assume(i1 true) [ "align"(ptr @memB_cons_buff_0, i64 32) ]
  call void @llvm.assume(i1 true) [ "align"(ptr @memA_cons_buff_0, i64 32) ]
  call void @matmul_bf16_bf16(ptr @memA_cons_buff_0, ptr @memB_cons_buff_0, ptr @memC_buff_1)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 50, i32 1)
  call void @llvm.aie2.acquire(i32 49, i32 -1)
  call void @llvm.aie2.acquire(i32 51, i32 -1)
  ...
  call void @llvm.assume(i1 true) [ "align"(ptr @memB_cons_buff_1, i64 32) ]
  call void @llvm.assume(i1 true) [ "align"(ptr @memA_cons_buff_1, i64 32) ]
  call void @matmul_bf16_bf16(ptr @memA_cons_buff_1, ptr @memB_cons_buff_1, ptr @memC_buff_1)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 50, i32 1)
  %18 = add i64 %15, 2
  br label %14
