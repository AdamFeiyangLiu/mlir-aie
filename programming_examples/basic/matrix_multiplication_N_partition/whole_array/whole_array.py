...
def main():
    ...
    argparser.add_argument("-N1", type=int, default=512)
...
def my_matmul(
    ...
    n_tiles_per_core = (M // m) * (N1 // n) // n_aie_cores
    ...
    def device_body():
        ...
        @runtime_sequence(
            ...
            np.ndarray[(K * N1,), np.dtype[dtype_in]],
            np.ndarray[(M * N1,), np.dtype[dtype_out]],
        )
        def sequence(A, B, C):
                ...
                for pingpong in [0, 1]:
                    ...
                    for tile_row in range(tb_n_rows):
                        ...
                        for col in range(n_aie_cols):
                            ...
                            C_sizes = [1, N1 // n // n_aie_cols, m * n_aie_rows, n]
                            ...
                            if not b_col_maj:
                                B_sizes = [N1 // n // n_aie_cols, K // k, k, n]
                                B_strides = [n * n_aie_cols, k * N, N, 1]
                            else:
                                B_sizes = [N1 // n // n_aie_cols, K // k, n, k]
