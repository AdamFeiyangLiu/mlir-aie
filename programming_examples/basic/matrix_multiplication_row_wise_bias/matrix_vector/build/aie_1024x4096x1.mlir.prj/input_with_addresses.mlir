module {
  aie.device(npu1_4col) {
    ...
    aiex.runtime_sequence @sequence(%arg0: memref<4194304xi16>, %arg1: memref<4096xi16>, %arg2: memref<1024xi32>) {
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][8, 1, 1, 4096][0, 0, 0, 1]) {id = 2 : i64, metadata = @inB} : memref<4096xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 0][8, 128, 32, 32][131072, 32, 4096, 1]) {id = 1 : i64, metadata = @memA0} : memref<4194304xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][1, 1, 1, 256][0, 0, 0, 1]) {id = 0 : i64, metadata = @outC0} : memref<1024xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 1048576][8, 128, 32, 32][131072, 32, 4096, 1]) {id = 1 : i64, metadata = @memA1} : memref<4194304xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 256][1, 1, 1, 256][0, 0, 0, 1]) {id = 0 : i64, metadata = @outC1} : memref<1024xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 2097152][8, 128, 32, 32][131072, 32, 4096, 1]) {id = 1 : i64, metadata = @memA2} : memref<4194304xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 512][1, 1, 1, 256][0, 0, 0, 1]) {id = 0 : i64, metadata = @outC2} : memref<1024xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 3145728][8, 128, 32, 32][131072, 32, 4096, 1]) {id = 1 : i64, metadata = @memA3} : memref<4194304xi16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 768][1, 1, 1, 256][0, 0, 0, 1]) {id = 0 : i64, metadata = @outC3} : memref<1024xi32>
