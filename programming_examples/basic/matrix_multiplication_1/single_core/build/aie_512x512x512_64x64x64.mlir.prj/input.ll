...
@inB_cons_buff_1 = external global [64 x [64 x i16]]
@inB_cons_buff_0 = external global [64 x [64 x i16]]
...
@memC_cons_buff_1 = external global [64 x [64 x i16]]
@memC_cons_buff_0 = external global [64 x [64 x i16]]
@outC_cons = external global [64 x [64 x i16]]
@outC = external global [64 x [64 x i16]]
@memC_cons = external global [64 x [64 x i16]]
@memC = external global [64 x [64 x i16]]
@memB_cons = external global [64 x [64 x i16]]
@memB = external global [64 x [64 x i16]]
@inB_cons = external global [64 x [64 x i16]]
@inB = external global [64 x [64 x i16]]
...
11:                                               ; preds = %8
  ...
  call void @matmul_i16_i16(ptr @memA_cons_buff_0, ptr @memB_cons_buff_0, ptr @memC_buff_0)
  ...
  call void @matmul_i16_i16(ptr @memA_cons_buff_1, ptr @memB_cons_buff_1, ptr @memC_buff_0)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 50, i32 1)
  %12 = add i64 %9, 2
  br label %8
...
17:                                               ; preds = %14
  ...
  call void @llvm.assume(i1 true) [ "align"(ptr @memB_cons_buff_0, i64 32) ]
  call void @llvm.assume(i1 true) [ "align"(ptr @memA_cons_buff_0, i64 32) ]
  call void @matmul_i16_i16(ptr @memA_cons_buff_0, ptr @memB_cons_buff_0, ptr @memC_buff_1)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 50, i32 1)
  call void @llvm.aie2.acquire(i32 49, i32 -1)
  call void @llvm.aie2.acquire(i32 51, i32 -1)
  ...
  call void @llvm.assume(i1 true) [ "align"(ptr @memB_cons_buff_1, i64 32) ]
  call void @llvm.assume(i1 true) [ "align"(ptr @memA_cons_buff_1, i64 32) ]
  call void @matmul_i16_i16(ptr @memA_cons_buff_1, ptr @memB_cons_buff_1, ptr @memC_buff_1)
  call void @llvm.aie2.release(i32 48, i32 1)
  call void @llvm.aie2.release(i32 50, i32 1)
  %18 = add i64 %15, 2
  br label %14
