...
void add_default_options(po::options_description &desc) {
  desc.add_options()("help,h", "produce help message")(
      ...
      (  "new_xclbin, new_xclbin", po::value<std::string>()->required()) 
      (
      ...
      ("new_instr,new_inst", po::value<std::string>()->required())(
      ...
      "Matrix size N")
        ("M1,M1", po::value<int>()->required(), "Matrix size M1")
        ("N1,N1", po::value<int>()->required(), "Matrix size N1")
