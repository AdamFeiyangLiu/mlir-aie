    ...
    with mlir_mod_ctx() as ctx:
        ...
        def device_body():
            ...
            def sequence(A, B, C):
                ...
                num_iter = M_div_m_div_n_cols // n_rows
                for j in range(num_iter):
                    for col in range(n_cols):
                        B_size3 = M_div_m_div_n_cols// n_cols// num_iter
                        npu_dma_memcpy_nd(
                    ...
                    for col in range(n_cols):
                        A_offset = (col) * M_div_m_div_n_cols * m * K//num_iter +j*K*M//num_iter
                    ...
                    for col in range(n_cols):
                        C_offset = col * M // n_cols//num_iter +j*M//num_iter
                        C_size0 = C_sz_div_n_cols//num_iter
                        npu_dma_memcpy_nd(
                    ...
                    dma_wait(*[memC_fifos[col] for col in range(n_cols)])
