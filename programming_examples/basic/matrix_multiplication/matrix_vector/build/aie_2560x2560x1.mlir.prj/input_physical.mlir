module {
  aie.device(npu1_4col) {
    ...
    %inB_cons_buff_0 = aie.buffer(%tile_0_2) {address = 5376 : i32, sym_name = "inB_cons_buff_0"} : memref<32xi16> 
    %inB_cons_buff_1 = aie.buffer(%tile_0_2) {address = 5440 : i32, sym_name = "inB_cons_buff_1"} : memref<32xi16> 
    ...
    %inB_prod_lock = aie.lock(%shim_noc_tile_0_0, 4) {init = 1 : i32, sym_name = "inB_prod_lock"}
    %inB_cons_lock = aie.lock(%shim_noc_tile_0_0, 5) {init = 0 : i32, sym_name = "inB_cons_lock"}
    ...
    ^bb6(%5: index):  // 2 preds: ^bb5, ^bb7
      %6 = arith.cmpi slt, %5, %c36_4 : index
    ...
    ^bb9:  // pred: ^bb1
      ...
      %c36_8 = arith.constant 36 : index
      %c1_9 = arith.constant 1 : index
      %c2_10 = arith.constant 2 : index
      cf.br ^bb10(%c0_7 : index)
    ^bb10(%9: index):  // 2 preds: ^bb9, ^bb11
      %10 = arith.cmpi slt, %9, %c36_8 : index
