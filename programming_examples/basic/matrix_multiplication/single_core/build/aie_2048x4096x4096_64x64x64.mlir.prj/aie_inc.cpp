...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd0), /* addrA */ 0x88000,  /* len */ 8192));
...
dma_tile_0_1_bd_2_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 4, /* Size */ 8};
dma_tile_0_1_bd_2_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 32, /* Size */ 4};
dma_tile_0_1_bd_2_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 4};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd2), &dma_tile_0_1_bd_2_tensor, 0x88000,  /* len */ 8192));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd24), /* addrA */ 0x84000,  /* len */ 8192));
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd26), &dma_tile_0_1_bd_26_tensor, 0x84000,  /* len */ 8192));
...
dma_tile_0_1_bd_6_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 2, /* Size */ 4};
dma_tile_0_1_bd_6_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 8, /* Size */ 16};
...
dma_tile_0_1_bd_7_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 2, /* Size */ 4};
dma_tile_0_1_bd_7_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 8, /* Size */ 16};
dma_tile_0_1_bd_7_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 2};
...
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd27), &dma_tile_0_1_bd_27_tensor, 0x86000,  /* len */ 8192));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd25), /* addrA */ 0x86000,  /* len */ 8192));
...
dma_tile_0_1_bd_3_tensor.Dim[2].AieMlDimDesc = { /* Stride */ 4, /* Size */ 8};
dma_tile_0_1_bd_3_tensor.Dim[1].AieMlDimDesc = { /* Stride */ 32, /* Size */ 4};
dma_tile_0_1_bd_3_tensor.Dim[0].AieMlDimDesc = { /* Stride */ 1, /* Size */ 4};
__mlir_aie_try(XAie_DmaSetMultiDimAddr(&(dma_tile01_bd3), &dma_tile_0_1_bd_3_tensor, 0x8A000,  /* len */ 8192));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile01_bd1), /* addrA */ 0x8A000,  /* len */ 8192));
...
// buffer memC_buff_0 with unsupported type memref<64x64xbf16>;
// buffer memC_buff_1 with unsupported type memref<64x64xbf16>;
// buffer memB_cons_buff_0 with unsupported type memref<64x64xbf16>;
// buffer memB_cons_buff_1 with unsupported type memref<64x64xbf16>;
// buffer memA_cons_buff_0 with unsupported type memref<64x64xbf16>;
// buffer memA_cons_buff_1 with unsupported type memref<64x64xbf16>;
// buffer memC_cons_buff_0 with unsupported type memref<64x64xbf16>;
// buffer memC_cons_buff_1 with unsupported type memref<64x64xbf16>;
// buffer inB_cons_buff_0 with unsupported type memref<64x64xbf16>;
// buffer inB_cons_buff_1 with unsupported type memref<64x64xbf16>;
// buffer inA_cons_buff_0 with unsupported type memref<64x64xbf16>;
// buffer inA_cons_buff_1 with unsupported type memref<64x64xbf16>;
