module {
  aie.device(npu1_4col) {
    ...
    aiex.runtime_sequence @sequence(%arg0: memref<65536xbf16>, %arg1: memref<65536xbf16>, %arg2: memref<65536xbf16>) {
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][1, 1, 256, 64][65536, 256, 256, 1]) {id = 0 : i64, metadata = @C_L2L3_0} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 0][1, 4, 64, 64][0, 64, 256, 1]) {id = 1 : i64, metadata = @A_L3L2_0} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][1, 4, 64, 64][256, 16384, 256, 1]) {id = 2 : i64, metadata = @B_L3L2_0} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 64][1, 1, 256, 64][65536, 256, 256, 1]) {id = 0 : i64, metadata = @C_L2L3_1} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 16384][1, 4, 64, 64][0, 64, 256, 1]) {id = 1 : i64, metadata = @A_L3L2_1} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 64][1, 4, 64, 64][256, 16384, 256, 1]) {id = 2 : i64, metadata = @B_L3L2_1} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 128][1, 1, 256, 64][65536, 256, 256, 1]) {id = 0 : i64, metadata = @C_L2L3_2} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 32768][1, 4, 64, 64][0, 64, 256, 1]) {id = 1 : i64, metadata = @A_L3L2_2} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 128][1, 4, 64, 64][256, 16384, 256, 1]) {id = 2 : i64, metadata = @B_L3L2_2} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 192][1, 1, 256, 64][65536, 256, 256, 1]) {id = 0 : i64, metadata = @C_L2L3_3} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 49152][1, 4, 64, 64][0, 64, 256, 1]) {id = 1 : i64, metadata = @A_L3L2_3} : memref<65536xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 192][1, 4, 64, 64][256, 16384, 256, 1]) {id = 2 : i64, metadata = @B_L3L2_3} : memref<65536xbf16>
