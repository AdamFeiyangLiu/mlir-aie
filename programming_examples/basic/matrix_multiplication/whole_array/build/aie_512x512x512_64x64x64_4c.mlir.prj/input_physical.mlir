module {
  aie.device(npu1_4col) {
    ...
    aiex.runtime_sequence @sequence(%arg0: memref<262144xbf16>, %arg1: memref<262144xbf16>, %arg2: memref<262144xbf16>) {
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][2, 2, 256, 64][131072, 256, 512, 1]) {id = 0 : i64, metadata = @C_L2L3_0} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 0][2, 8, 64, 64][0, 64, 512, 1]) {id = 1 : i64, metadata = @A_L3L2_0} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][2, 8, 64, 64][256, 32768, 512, 1]) {id = 2 : i64, metadata = @B_L3L2_0} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 131072][2, 8, 64, 64][0, 64, 512, 1]) {id = 3 : i64, metadata = @A_L3L2_0} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][2, 8, 64, 64][256, 32768, 512, 1]) {id = 4 : i64, metadata = @B_L3L2_0} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 64][2, 2, 256, 64][131072, 256, 512, 1]) {id = 0 : i64, metadata = @C_L2L3_1} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 32768][2, 8, 64, 64][0, 64, 512, 1]) {id = 1 : i64, metadata = @A_L3L2_1} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 64][2, 8, 64, 64][256, 32768, 512, 1]) {id = 2 : i64, metadata = @B_L3L2_1} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 163840][2, 8, 64, 64][0, 64, 512, 1]) {id = 3 : i64, metadata = @A_L3L2_1} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 64][2, 8, 64, 64][256, 32768, 512, 1]) {id = 4 : i64, metadata = @B_L3L2_1} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 128][2, 2, 256, 64][131072, 256, 512, 1]) {id = 0 : i64, metadata = @C_L2L3_2} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 65536][2, 8, 64, 64][0, 64, 512, 1]) {id = 1 : i64, metadata = @A_L3L2_2} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 128][2, 8, 64, 64][256, 32768, 512, 1]) {id = 2 : i64, metadata = @B_L3L2_2} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 196608][2, 8, 64, 64][0, 64, 512, 1]) {id = 3 : i64, metadata = @A_L3L2_2} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 128][2, 8, 64, 64][256, 32768, 512, 1]) {id = 4 : i64, metadata = @B_L3L2_2} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 192][2, 2, 256, 64][131072, 256, 512, 1]) {id = 0 : i64, metadata = @C_L2L3_3} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 98304][2, 8, 64, 64][0, 64, 512, 1]) {id = 1 : i64, metadata = @A_L3L2_3} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 192][2, 8, 64, 64][256, 32768, 512, 1]) {id = 2 : i64, metadata = @B_L3L2_3} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 229376][2, 8, 64, 64][0, 64, 512, 1]) {id = 3 : i64, metadata = @A_L3L2_3} : memref<262144xbf16>
