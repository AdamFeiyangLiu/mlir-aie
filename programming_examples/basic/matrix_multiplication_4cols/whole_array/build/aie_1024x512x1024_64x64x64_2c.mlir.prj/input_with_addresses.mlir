module {
  aie.device(npu1_2col) {
    ...
    aiex.runtime_sequence @sequence(%arg0: memref<524288xbf16>, %arg1: memref<524288xbf16>, %arg2: memref<1048576xbf16>) {
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][2, 8, 256, 64][262144, 128, 1024, 1]) {id = 0 : i64, metadata = @C_L2L3_0} : memref<1048576xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 0][8, 8, 128, 64][0, 64, 512, 1]) {id = 1 : i64, metadata = @A_L3L2_0} : memref<524288xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][8, 8, 64, 64][128, 65536, 1024, 1]) {id = 2 : i64, metadata = @B_L3L2_0} : memref<524288xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 131072][8, 8, 128, 64][0, 64, 512, 1]) {id = 3 : i64, metadata = @A_L3L2_0} : memref<524288xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][8, 8, 64, 64][128, 65536, 1024, 1]) {id = 4 : i64, metadata = @B_L3L2_0} : memref<524288xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 64][2, 8, 256, 64][262144, 128, 1024, 1]) {id = 0 : i64, metadata = @C_L2L3_1} : memref<1048576xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 65536][8, 8, 128, 64][0, 64, 512, 1]) {id = 1 : i64, metadata = @A_L3L2_1} : memref<524288xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 64][8, 8, 64, 64][128, 65536, 1024, 1]) {id = 2 : i64, metadata = @B_L3L2_1} : memref<524288xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 196608][8, 8, 128, 64][0, 64, 512, 1]) {id = 3 : i64, metadata = @A_L3L2_1} : memref<524288xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 64][8, 8, 64, 64][128, 65536, 1024, 1]) {id = 4 : i64, metadata = @B_L3L2_1} : memref<524288xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 524288][2, 8, 256, 64][262144, 128, 1024, 1]) {id = 8 : i64, metadata = @C_L2L3_0} : memref<1048576xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 262144][8, 8, 128, 64][0, 64, 512, 1]) {id = 9 : i64, metadata = @A_L3L2_0} : memref<524288xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][8, 8, 64, 64][128, 65536, 1024, 1]) {id = 10 : i64, metadata = @B_L3L2_0} : memref<524288xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 393216][8, 8, 128, 64][0, 64, 512, 1]) {id = 11 : i64, metadata = @A_L3L2_0} : memref<524288xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][8, 8, 64, 64][128, 65536, 1024, 1]) {id = 12 : i64, metadata = @B_L3L2_0} : memref<524288xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 524352][2, 8, 256, 64][262144, 128, 1024, 1]) {id = 8 : i64, metadata = @C_L2L3_1} : memref<1048576xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 327680][8, 8, 128, 64][0, 64, 512, 1]) {id = 9 : i64, metadata = @A_L3L2_1} : memref<524288xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 64][8, 8, 64, 64][128, 65536, 1024, 1]) {id = 10 : i64, metadata = @B_L3L2_1} : memref<524288xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 458752][8, 8, 128, 64][0, 64, 512, 1]) {id = 11 : i64, metadata = @A_L3L2_1} : memref<524288xbf16>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 64][8, 8, 64, 64][128, 65536, 1024, 1]) {id = 12 : i64, metadata = @B_L3L2_1} : memref<524288xbf16>
