; ModuleID = '/home/adam/mlir-aie/programming_examples/basic/matrix_multiplication_4cols/whole_array/build/aie_512x512x512_64x64x64_4c.mlir.prj/input.ll'
...
2:                                                ; preds = %.preheader, %2
  %3 = phi i1 [ true, %.preheader ], [ false, %2 ]
  ...
  tail call void @llvm.aie2.release(i32 50, i32 1)
  tail call void @llvm.aie2.release(i32 53, i32 1)
  br i1 %3, label %2, label %4

4:                                                ; preds = %2
  %5 = add nuw nsw i64 %1, 1
  %6 = icmp ult i64 %1, 4294967294
