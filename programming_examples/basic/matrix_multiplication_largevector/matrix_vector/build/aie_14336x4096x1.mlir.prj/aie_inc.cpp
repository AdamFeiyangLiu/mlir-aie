...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile12_bd2), /* addrA */ 0x1400,  /* len */ 128));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile12_bd4), XAie_LockInit(4,-1),XAie_LockInit(5,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile12_bd4), /* addrA */ 0x1500,  /* len */ 64));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile12_bd5), XAie_LockInit(4,-1),XAie_LockInit(5,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile12_bd5), /* addrA */ 0x1540,  /* len */ 64));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile12_bd3), /* addrA */ 0x1480,  /* len */ 128));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(1,2), /* ChNum */1, /* dmaDir */ DMA_S2MM, /* BdNum */4, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile22_bd2), /* addrA */ 0x1400,  /* len */ 128));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile22_bd4), XAie_LockInit(4,-1),XAie_LockInit(5,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile22_bd4), /* addrA */ 0x1500,  /* len */ 64));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile22_bd5), XAie_LockInit(4,-1),XAie_LockInit(5,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile22_bd5), /* addrA */ 0x1540,  /* len */ 64));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile22_bd3), /* addrA */ 0x1480,  /* len */ 128));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(2,2), /* ChNum */1, /* dmaDir */ DMA_S2MM, /* BdNum */4, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile32_bd2), /* addrA */ 0x1400,  /* len */ 128));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile32_bd4), /* addrA */ 0x1500,  /* len */ 64));
...
__mlir_aie_try(XAie_DmaSetLock(&(dma_tile32_bd5), XAie_LockInit(4,-1),XAie_LockInit(5,1)));
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile32_bd5), /* addrA */ 0x1540,  /* len */ 64));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile32_bd3), /* addrA */ 0x1480,  /* len */ 128));
...
__mlir_aie_try(XAie_DmaChannelSetStartQueue(&(ctx->DevInst), XAie_TileLoc(3,2), /* ChNum */1, /* dmaDir */ DMA_S2MM, /* BdNum */4, /* Repeat */ 1, /* EnToken */ XAIE_DISABLE));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd0), /* addrA */ 0x80000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd3), /* addrA */ 0x80800,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile11_bd1), /* addrA */ 0x80800,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd0), /* addrA */ 0x80000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd2), /* addrA */ 0x80000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd3), /* addrA */ 0x80800,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile21_bd1), /* addrA */ 0x80800,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd0), /* addrA */ 0x80000,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd3), /* addrA */ 0x80800,  /* len */ 2048));
...
__mlir_aie_try(XAie_DmaSetAddrLen(&(dma_tile31_bd1), /* addrA */ 0x80800,  /* len */ 2048));
...
__mlir_aie_try(XAie_StrmConnCctEnable(&(ctx->DevInst), XAie_TileLoc(x,y), SOUTH, 7, WEST, 2));
__mlir_aie_try(XAie_StrmPktSwMstrPortEnable(&(ctx->DevInst), XAie_TileLoc(x,y), SOUTH, 0, /* drop_header */ XAIE_SS_PKT_DONOT_DROP_HEADER, /* arbiter */ 5, /* MSelEn */ 0x8));
__mlir_aie_try(XAie_StrmPktSwSlavePortEnable(&(ctx->DevInst), XAie_TileLoc(x,y), CTRL, 0));
__mlir_aie_try(XAie_StrmPktSwSlaveSlotEnable(&(ctx->DevInst), XAie_TileLoc(x,y), CTRL, 0, /* slot */ 0, /* packet */ XAie_PacketInit(15,0), /* mask */ 0x1F, /* msel */ 3, /* arbiter */ 5));
...
// buffer memA2_cons_buff_0 with unsupported type memref<1024xi16>;
// buffer memA2_cons_buff_1 with unsupported type memref<1024xi16>;
// buffer memA3_cons_buff_0 with unsupported type memref<1024xi16>;
// buffer memA3_cons_buff_1 with unsupported type memref<1024xi16>;
// buffer inB_0_cons_buff_0 with unsupported type memref<32xi16>;
// buffer inB_0_cons_buff_1 with unsupported type memref<32xi16>;
...
// buffer inB_2_cons_buff_0 with unsupported type memref<32xi16>;
// buffer inB_2_cons_buff_1 with unsupported type memref<32xi16>;
const int outC2_buff_0_offset = 5120;
int32_t mlir_aie_read_buffer_outC2_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(2,2), outC2_buff_0_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_outC2_buff_0(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(2,2), outC2_buff_0_offset + (index*4), int_value);
return rc;
}
const int outC2_buff_1_offset = 5248;
int32_t mlir_aie_read_buffer_outC2_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(2,2), outC2_buff_1_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_outC2_buff_1(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(2,2), outC2_buff_1_offset + (index*4), int_value);
return rc;
}
// buffer inA2_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer inA2_cons_buff_1 with unsupported type memref<32x32xi16>;
// buffer inB_1_cons_buff_0 with unsupported type memref<32xi16>;
// buffer inB_1_cons_buff_1 with unsupported type memref<32xi16>;
const int outC1_buff_0_offset = 5120;
int32_t mlir_aie_read_buffer_outC1_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(1,2), outC1_buff_0_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_outC1_buff_0(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(1,2), outC1_buff_0_offset + (index*4), int_value);
return rc;
}
const int outC1_buff_1_offset = 5248;
int32_t mlir_aie_read_buffer_outC1_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(1,2), outC1_buff_1_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_outC1_buff_1(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(1,2), outC1_buff_1_offset + (index*4), int_value);
return rc;
}
// buffer inA1_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer inA1_cons_buff_1 with unsupported type memref<32x32xi16>;
...
// buffer inB_3_cons_buff_0 with unsupported type memref<32xi16>;
// buffer inB_3_cons_buff_1 with unsupported type memref<32xi16>;
const int outC3_buff_0_offset = 5120;
int32_t mlir_aie_read_buffer_outC3_buff_0(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(3,2), outC3_buff_0_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_outC3_buff_0(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(3,2), outC3_buff_0_offset + (index*4), int_value);
return rc;
}
const int outC3_buff_1_offset = 5248;
int32_t mlir_aie_read_buffer_outC3_buff_1(aie_libxaie_ctx_t* ctx, int index) {
u32 value; auto rc = XAie_DataMemRdWord(&(ctx->DevInst), XAie_TileLoc(3,2), outC3_buff_1_offset + (index*4), &value);
  return value;
}
int mlir_aie_write_buffer_outC3_buff_1(aie_libxaie_ctx_t* ctx, int index, int32_t value) {
  int32_t int_value = value;
AieRC rc =    XAie_DataMemWrWord(&(ctx->DevInst), XAie_TileLoc(3,2), outC3_buff_1_offset + (index*4), int_value);
return rc;
}
// buffer inA3_cons_buff_0 with unsupported type memref<32x32xi16>;
// buffer inA3_cons_buff_1 with unsupported type memref<32x32xi16>;
// buffer memA1_cons_buff_0 with unsupported type memref<1024xi16>;
// buffer memA1_cons_buff_1 with unsupported type memref<1024xi16>;
int mlir_aie_acquire_inB_0_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 4;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_inB_0_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 4;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_inB_0_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 5;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_inB_0_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 5;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(0,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_inB_1_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 4;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_inB_1_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 4;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_inB_1_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 5;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_inB_1_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 5;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_inB_2_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 4;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_inB_2_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 4;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_inB_2_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 5;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_inB_2_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 5;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_inB_3_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 4;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_inB_3_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 4;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_inB_3_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 5;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_inB_3_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 5;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
...
int mlir_aie_acquire_outC3_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_outC3_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_outC3_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_outC3_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_outC3_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_outC3_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_outC3_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_outC3_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_inA3_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_inA3_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_inA3_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_inA3_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,2), XAie_LockInit(id,value), timeout);
}
...
int mlir_aie_acquire_memA3_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memA3_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_memA3_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(3,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memA3_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(3,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_outC2_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_outC2_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_outC2_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_outC2_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_outC2_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_outC2_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_outC2_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_outC2_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_inA2_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_inA2_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_inA2_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_inA2_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,2), XAie_LockInit(id,value), timeout);
}
...
int mlir_aie_acquire_memA2_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memA2_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_memA2_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(2,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memA2_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(2,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_outC1_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(1,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_outC1_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(1,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_outC1_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(1,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_outC1_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(1,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_outC1_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_outC1_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 2;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_outC1_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_outC1_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 3;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_inA1_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_inA1_cons_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_inA1_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_inA1_cons_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(1,2), XAie_LockInit(id,value), timeout);
}
...
int mlir_aie_acquire_memA1_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(1,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memA1_prod_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 0;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(1,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_acquire_memA1_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockAcquire(&(ctx->DevInst), XAie_TileLoc(1,0), XAie_LockInit(id,value), timeout);
}
int mlir_aie_release_memA1_cons_lock(aie_libxaie_ctx_t* ctx, int value, int timeout) {
  const int id = 1;
  return XAie_LockRelease(&(ctx->DevInst), XAie_TileLoc(1,0), XAie_LockInit(id,value), timeout);
}
